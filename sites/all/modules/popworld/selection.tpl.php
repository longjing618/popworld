  ...
  <div id="container" style="height:100%">
   ...
   <?php endif; ?>
    ...
    <div id="content" style="height:100%">
      ...
      <section id="post-content" role="main" style="background-image: url('pics/selection_r_bg.png');background-size:100% 100%;min-height:700px">
        <?php print $messages; ?>
...
<?php global $base_url; drupal_add_js('jQuery(".accept-help").live( "click", function(){var str = jQuery("a[href$=\"user\"]").html();
str = str.split("Darwin dollars: ");if(str[1] >= 30) jQuery.msg({ content : "You cannot get more Darwin dollars" });else jQuery.get("'.$base_url.'/node/get/ajax/"+jQuery(this).next(".node-id").val(),function(data){alert(data)}) } );', 'inline');drupal_add_js('custom_libs/jquery.center.min.js', 'file');drupal_add_js('custom_libs/jquery.msg.min.js', 'file');drupal_add_css('custom_libs/jquery.msg.css', array('group' => CSS_THEME, 'every_page' => FALSE));?>
