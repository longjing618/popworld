...
<script src="jquery-ui/jquery-ui.js"></script>
  ...
  <script src='custom_libs/customjs_nrmating.js'></script>
...
#slider label, #slider_prob label {
  position: absolute;
  width: 20px;
  margin-top: 12px;
  margin-left: -10px;
...
<body style="height:100%">
	...
	<div id="draggable" class="ui-widget-content" style="height:15%;width:50%;float:left">
		<table>
			...
			<tr>
				<td style="width:20%">Probability of inbreeding (F): </td>
				<td style="width:60%">
					<div id="slider_prob" style="width:80%;"></div>
				</td>
				<td style="width:20%"><input id="prob" style="width:50%"></input></td>
			</tr>			
			<tr>
