...
<script src="jquery-ui/jquery-ui.js"></script>
  ...
  <script src='custom_libs/customjs_mutation.js'></script>
...
<body style="height:100%">
	...
	<div id="draggable" class="ui-widget-content" style="height:15%;width:50%;float:left">
		<table>
			...
			<tr>
				<td style="width:20%" colspan="2">A1 to A2 mutation rate:(0.00001 - 0.00000001) </td>
				<td style="width:20%"><input id="a1toa2" style="width:50%"></input></td>
			</tr>
			<tr>
				<td style="width:20%" colspan="2">A2 to A1 mutation rate:(0.00001 - 0.00000001) </td>
				<td style="width:20%"><input id="a2toa1" style="width:50%"></input></td>
			</tr>
			<tr>
