...
<script src="jquery-ui/jquery-ui.js"></script>
  ...
  <script src='custom_libs/customjs_migration.js'></script>
...
#slider label, #slider_a1start label, #slider_fraction label {
  position: absolute;
  width: 20px;
  margin-top: 12px;
  margin-left: -10px;
...
function clear()
{
	...
	$("#steps").val("");
	$("#slider").slider('value', "");
	$("#slider_a1start").slider('value', "");
	$("#slider_fraction").slider('value', "");
	basics = {};
}
function restart()
{
...
<body style="height:100%">
	...
	<div id="draggable" class="ui-widget-content" style="height:15%;width:50%;float:left">
		<table>
			...
			<tr>
				<td style="width:20%">Frequency of A1 * in Migrants: </td>
				<td style="width:60%">
					<div id="slider_a1start" style="width:80%;"></div>
				</td>
				<td style="width:20%"><input id="a1start" style="width:50%"></input></td>
			</tr>	
			<tr>
				<td style="width:20%">Fraction of Migrants(M): </td>
				<td style="width:60%">
					<div id="slider_fraction" style="width:80%;"></div>
				</td>
				<td style="width:20%"><input id="fraction" style="width:50%"></input></td>
			</tr>						
			<tr>
